...
`tooldevs` es una herramienta de línea de comandos escrita en Python que automatiza tres tareas frecuentes de los desarrolladores que mantienen proyectos en GitHub y se divierten compartiendo sus logros en LinkedIn:

1. **Commit inteligente** – Analiza el diff de tu repositorio, genera un mensaje de commit siguiendo la convención _Conventional Commits_ mediante IA y realiza el `push` a la rama principal.
...
3. **Publicación en LinkedIn** – Crea una publicación de impacto para la sección _Experiencia_ de Linkeden a partir de la URL del repositorio y de la descripción generada por IA.
...
git clone https://github.com/danilo1992-sys/tooldevs.git
cd tooldevs
...
- **Commit AI‑driven**: mensajes de commit generados automáticamente siguiendo _Conventional Commits_.
...
3. Haz commit siguiendo la convención _Conventional Commits_.
...
Con esto basta con ejecutar `tooldevs` desde cualquier terminal dentro del proyecto.
...
--- > **¡Gracias por usar ToolDevs CLI Toolkit!**

> Si tienes alguna sugerencia de mejora, abre un _issue_ o un _pull request_. 🎉
